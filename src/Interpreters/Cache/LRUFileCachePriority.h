...
/// Based on the LRU algorithm implementation.
/// The record with the lowest priority is stored at the head of the queue.
/// The record with the highest priority is stored at the tail.
...
public:
    ...
    Iterator add(const Entry & entry, const CacheGuard::Lock &) override;
