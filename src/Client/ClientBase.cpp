    ...
    std::optional<Exception> current_exception)
{
    ...
    if (!parsed_query)
    {
        if (ignore_error)
        {
            ...
            return MultiQueryProcessingStage::CONTINUE;
        }
...
bool ClientBase::processMultiQuery(const String & all_queries_text)
{
    ...
    while (true)
    {
        ...
        switch (stage)
        {
            ...
            case MultiQueryProcessingStage::CONTINUE:
            {
                continue;
            }
            case MultiQueryProcessingStage::EXECUTE_QUERY:
            {
                ...
                process_single_query(String(this_query_begin, this_query_end - this_query_begin), query_to_execute, parsed_query);
